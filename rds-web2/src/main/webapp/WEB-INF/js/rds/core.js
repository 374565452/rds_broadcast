var succ1 = '<div class=\"text-success h tc\"><i class="glyphicon glyphicon-ok-sign"></i>&nbsp;&nbsp;';
var succ2 = '</div>';
var err1 = '<div class=\"text-danger h tc\"><i class="glyphicon glyphicon-remove-sign"></i>&nbsp;&nbsp;';
var err2 = '</div>';
var loadText = "<div class='tc h tip'><p><img src=\"css/images/loading.gif\" />&nbsp;&nbsp;努力加载中，请稍后...</p></div>";
 ...
 */
//连续请求两次就可以出现正在加载的图标，是因为 在第二次请求的时间isFloag被设置为true
var isFloat = false;
